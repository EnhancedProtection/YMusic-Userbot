...
- `{PREFIX}pl [link|reply to link]` - Play a song from playlist by giving song link or reply to a link
- `{PREFIX}playlist [link|reply to link]` - Play a song from playlist by giving song link or reply to a link
